...
if version == 1:
    ...
    if v25_mode == "joint":
        ...
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v29_jointGLM_SVpain_SVmoney_RT")
    elif v25_mode == "separate":
        outpath = opj(base_v25, "v25_high_STA_TAI_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v29_long_SVmoneypain_RT_sep")
    else:
