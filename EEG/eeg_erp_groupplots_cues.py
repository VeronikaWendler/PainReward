...
version = 24   # 1 for decision phase, 2 for passive phase, 3 = decision RT + 3 GLMs
...
if version == 1:
    ...
    outpath = opj(base_v24, "v24_high_accept_svpain_only")  
    outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v27_v24_high_accept_svpain_only")
    os.makedirs(outfigpath, exist_ok=True)
