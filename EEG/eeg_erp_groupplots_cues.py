...
version = 25   # 1 for decision phase, 2 for passive phase, 3 = decision RT + 3 GLMs
...
if version == 1:
    ...
    if v25_mode == "joint":
        outpath = opj(base_v25, "v25_low_STA_TAI_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v30_jointGLM_low_STA_TAI_RT")
    ...
    if v26_mode == "joint":
        outpath = opj(base_v26, "v26_low_STA_TAI_SV_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v32_jointGLM_low_STA_TAI_SV_RT")
    ...
    if v27_mode == "joint":
        ...
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v33_jointGLM_low_STA_SAI_RT")
    ...
    if v28_mode == "joint":
        outpath = opj(base_v28, "v26_low_STA_SAI_SV_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v33_jointGLM_low_STA_SAI_SV_RT")
