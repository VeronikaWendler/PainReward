...
version = 45  # 1 for decision phase, 2 for passive phase, 3 = decision RT + 3 GLMs
...
if version == 1:
    ...
    if v11_mode == "separate":
        outpath = opj(base_v11, "v11_separateGLMs")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v11_separateGLMs")
    elif v11_mode == "joint":
        outpath = opj(base_v11, "v11_jointGLM_pain_money_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v11_jointGLM_pain_money_RT")
    else:
    ...
    if v11_mode == "separate":
        outpath = opj(base_v11, "v12_separateGLMs")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v12_separateGLMs")
    elif v11_mode == "joint":
        outpath = opj(base_v11, "v12_jointGLM_pain_money_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v12_jointGLM_pain_money_RT")
    else:
    ...
    if v13_mode == "separate":
        outpath = opj(base_v11, "v13_separateGLMs")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v13_separateGLMs")
    elif v13_mode == "joint":
        outpath = opj(base_v11, "v13_jointGLM_pain_money_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v13_jointGLM_pain_money_RT")
    else:
        raise ValueError("v13_mode must be 'separate' or 'joint'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 14:
    base_v14 = opj(outpathall, 'statistics_new/erps_massuni_drift_sv_subsetAcceptPairM')
    if v14_mode == "separate":
        outpath = opj(base_v14, "v18_separateGLMs_raw")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v18_separateGLMsOV")
    elif v14_mode == "joint":
        outpath = opj(base_v14, "v18_jointGLM_pain_money_RT_raw")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v18_jointGLM_pain_money_RTOV")
    else:
    ...
    base_v16 = opj(outpathall, 'statistics_new/erps_massuni_drift_sv_subsetVD')
    if v16_mode == "separate":
        outpath = opj(base_v16, "v19_separateGLMs")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v19_separateGLMsOV")
    elif v16_mode == "joint":
        outpath = opj(base_v16, "v19_jointGLM_pain_money_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v19_jointGLM_pain_money_RTOV")
    else:
    ...
    base_v18 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v18_mode == "joint":
        outpath = opj(base_v18, "v18_long_SVmoneypain_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v21_jointGLM_SVpain_SVmoney_RT")
    elif v18_mode == "separate":
        outpath = opj(base_v18, "v18_long_SVmoneypain_RT_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v21_v18_long_SVmoneypain_RT_sep")
    else:
    ...
    base_v19 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v19_mode == "joint":
        outpath = opj(base_v19, "v19_long_SVmoneypain_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v22_jointGLM_SVpain_SVmoney_RT")
    elif v19_mode == "separate":
        outpath = opj(base_v19, "v19_long_SVmoneypain_RT_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v22_long_SVmoneypain_RT_sep")
    else:
        raise ValueError("v19_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 20:
    base_v20 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v20_mode == "joint":
        outpath = opj(base_v20, "v20_long_SVmoneypain_RT")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v23_jointGLM_SVpain_SVmoney_RT")
    elif v20_mode == "separate":
        outpath = opj(base_v20, "v20_long_SVmoneypain_RT_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v23_long_SVmoneypain_RT_sep")
    else:
        raise ValueError("v20_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 22:
    base_v22 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v22_mode == "joint":
    ...
    if v25_mode == "joint":
        ...
        outpath = opj(base_v25, "v25_low_STA_TAI_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v30_sepGLM_low_STA_TAI_RT")
    else:
    ...
    base_v26 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v26_mode == "joint":
        outpath = opj(base_v26, "v26_high_STA_TAI_SV_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v32_jointGLM_high_STA_TAI_SV_RT")
    elif v26_mode == "separate":
        outpath = opj(base_v26, "v26_low_STA_TAI_SV_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v32_sepGLM_low_STA_TAI_SV_RT")
    else:
        raise ValueError("v26_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    ...
    if v27_mode == "joint":
        ...
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v33_sepGLM_low_STA_SAI_RT")
    else:
        raise ValueError("v27_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 28:
    base_v28 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v28_mode == "joint":
        outpath = opj(base_v28, "v26_high_STA_SAI_SV_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v33_jointGLM_high_STA_SAI_SV_RT")
    elif v28_mode == "separate":
        outpath = opj(base_v28, "v26_low_STA_SAI_SV_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v33_sepGLM_low_STA_SAI_SV_RT")
    else:
    ...
    base_v31 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v31_mode == "joint":
        outpath = opj(base_v31, "v31_first_10_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v36_jointGLM_first10_RT")
    elif v31_mode == "separate":
        outpath = opj(base_v31, "v31_first_10_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v36_sepGLM_first10_RT")
    else:
        raise ValueError("v31_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    ...
    if v32_mode == "joint":
        ...
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v37_jointGLM_slow_RT_RT")
    ...
    if v40_mode == "joint":
        ...
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v45_rp_joint")
    elif v40_mode == "separate":
        outpath = opj(base_v39, "v40_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v45_rp_sep")
    else:
        raise ValueError("v38_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 41:
    base_v41 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v41_mode == "joint":
        outpath = opj(base_v41, "v41_rp_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v46_rp_joint")
    elif v41_mode == "separate":
        outpath = opj(base_v41, "v41_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v46_rp_sep")
    else:
        raise ValueError("v41_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 42:
    base_v42 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v42_mode == "joint":
        outpath = opj(base_v42, "v42_rp_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v47_rp_joint")
    elif v42_mode == "separate":
        outpath = opj(base_v42, "v42_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v47_rp_sep")
    else:
        raise ValueError("v42_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
    
elif version == 43:
    base_v43 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v43_mode == "joint":
        outpath = opj(base_v43, "v43_rp_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v48_rp_joint")
    elif v43_mode == "separate":
        outpath = opj(base_v43, "v43_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v48_rp_sep")
    else:
        raise ValueError("v43_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
    
elif version == 44:
    base_v44 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v44_mode == "joint":
        outpath = opj(base_v44, "v44_rp_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v49_rp_joint")
    elif v44_mode == "separate":
        outpath = opj(base_v44, "v44_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v49_rp_sep")
    else:
        raise ValueError("v43_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
    
elif version == 45:
    base_v45 = opj(outpathall, "statistics_new/erps_massuni_sv_cuelong")
    if v45_mode == "joint":
        outpath = opj(base_v45, "v45_rp_joint")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v50_rp_joint")
    elif v45_mode == "separate":
        outpath = opj(base_v45, "v45_rp_sep")
        outfigpath = opj(outpathall, "figures/erps_massuni_drift_sv_subsetOV/v50_rp_sep")
    else:
        raise ValueError("v45_mode must be 'joint' or 'separate'")
    os.makedirs(outfigpath, exist_ok=True)
...
if version == 16:
    regvars = ["painlevel", "moneylevel"]
    regvarsnames = ["Painlevel", "Moneylevel"]   
if version == 17 and v17_mode == "resid_joint":
...
if version == 17:
    plot_times = [-0.5, -0.4, -0.3, -0.2, -0.1, 0.0, 0.05, 0.1]  # seconds relative to response
...
if version == 11:
    ...
    beta_gavg = np.load(opj(outpath_glm, "ols_2ndlevel_betasavg.npy"), allow_pickle=True)  # list-like (2 Evoked)
    allbetas  = np.load(opj(outpath_glm, "ols_2ndlevel_betas.npy"), allow_pickle=True)    # (n_subj, 2, n_chan, n_time)

    # IMPORTANT: regvars must match the saved epochs filenames
    regvars = ["sv_pain_para", "sv_money"]
    regvarsnames = ["SV_pain_para", "SV_money"]
    ...
    # alpha correction: 2 regressors
    alpha_eff = param["alpha"] / len(regvars)   # Bonferroni across regressors
    print(f"[v11 plotting] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars)} regressors)")

    # Time points for topomaps (seconds → indices)
    times_pos = [np.abs(beta_gavg[0].times - t).argmin() for t in plot_times]
    ...
    for ridx, regvar in enumerate(regvars):
        ...
        regvarname = regvarsnames[ridx]
        cmap, vminmax = cmap_map.get(regvar, ("viridis", 6))
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            # p-values at this timepoint
            p_row = pvals[ridx][timepos, :]  # (n_channels,)

            # mask: significant non-mastoid channels
            mask = np.zeros_like(p_row, dtype=bool)
            ...
            ax.set_title(f"{regvarname}\n{int(plot_times[tidx]*1000)} ms",
                         fontdict={"size": param["labelfontsize"]-1},
                         pad=0.2)

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v11_topo_beta_{regvar}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )

            # one colorbar per regressor (at last time)
            if tidx == (len(plot_times)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v11_topo_beta_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )

        # -----------------------------------------
        # 2) Binned-by-regressor line plots
        # -----------------------------------------
        nbins = 5
        all_epos.metadata = all_epos.metadata.reset_index(drop=True)

        # qcut bins (robust to duplicates)
        unique_vals = all_epos.metadata[regvar].nunique()
        nbins_eff = min(nbins, unique_vals)
        ...
        # grand average per bin
        evokeds = {}
        for b in range(nbins_eff):
            ev_list = [s[b] for s in sub_evokeds if s[b] is not None]
            if len(ev_list) == 0:
                print(f"[v11] {regvar}: skipping bin {b+1} (no data)")
                continue
        ...
        for c in chan_to_plot:
            if c not in beta_ev.ch_names:
                print(f"[v11] Channel {c} not found in data; skipping")
                continue
            ...
            for bi, bin_id in enumerate(bin_ids):
                ax.plot(
                    evokeds[bin_id].times * 1000,
                    evokeds[bin_id].data[pick, :] * 1e6,
                    linewidth=2,
                    label=f"Bin {bin_id}",
                    color=plt.get_cmap(cmap)(bi / max(1, len(bin_ids)-1))
                )
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v11_bins_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )

            # make a colorbar legend figure (like your v1–3)
            if len(evokeds) > 0:
                fig_cb, ax_cb = plt.subplots(figsize=(4, 2.5))
                cbarout = mne.viz.plot_compare_evokeds(
                    evokeds,
                    picks=pick,
                    cmap=(regvarname + "\n(Bin)", cmap),
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v11_bins_cbar_{regvar}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )

        # -----------------------------------------
        # 3) Topo of binned amplitude at 0.6s
        # -----------------------------------------
        for bi, bin_id in enumerate(bin_ids):
            fig, ax = plt.subplots(figsize=(1.2, 1.2))

            tidx_06 = np.argmin(np.abs(evokeds[bin_id].times - 0.6))
            dat = evokeds[bin_id].data[:, tidx_06] * 1e6

            im, _ = plot_topomap(
                dat,
                pos=evokeds[bin_id].info,
                cmap=cmap,
                show=False,
                ch_type="eeg",
                outlines="head",
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v11_bins_topo_{regvar}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )

            # one colorbar per regressor (after last bin)
            if bi == (len(bin_ids)-1):
                fig2, cax = plt.subplots(figsize=(0.25, 1.2))
                cbar = fig2.colorbar(im, cax=cax, orientation="vertical", aspect=1)
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v11_bins_topo_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            ax.set_xlabel("Time (ms)", fontdict={"size": param["labelfontsize"]})
            ax.set_ylabel(f"β ({regvarname}, z)", fontdict={"size": param["labelfontsize"]})
            ax.axhline(0, linestyle="--", color="gray")
            ax.axvline(0, linestyle="--", color="gray")
            ...
            # significance bars from cluster p-map
            timestep = 1000.0 / param["testresampfreq"]
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v11_beta_meanSEM_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 12:
    ...
    # alpha correction: 2 regressors
    alpha_eff = param["alpha"] / len(regvars)   # Bonferroni across regressors
    print(f"[v12 plotting] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars)} regressors)")
    ...
    for ridx, regvar in enumerate(regvars):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            if tidx == (len(plot_times)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v12_topo_beta_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v12_bins_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if len(evokeds) > 0:
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v12_bins_cbar_{regvar}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v12_bins_topo_{regvar}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v12_bins_topo_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v12_beta_meanSEM_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 13:
    ...
    # alpha correction: 2 regressors
    alpha_eff = param["alpha"] / len(regvars)   # Bonferroni across regressors
    print(f"alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars)} regressors)")
    ...
    for ridx, regvar in enumerate(regvars):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v13_topo_beta_{regvar}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(plot_times)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v13_topo_beta_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for b in range(nbins_eff):
            ev_list = [s[b] for s in sub_evokeds if s[b] is not None]
            if len(ev_list) == 0:
                print(f"{regvar}: skipping bin {b+1} (no data)")
                continue
            evokeds[str(b+1)] = mne.grand_average(ev_list)
        ...
        for c in chan_to_plot:
            if c not in beta_ev.ch_names:
                print(f"Channel {c} not found in data; skipping")
                continue
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v13_bins_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if len(evokeds) > 0:
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v13_bins_cbar_{regvar}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v13_bins_topo_{regvar}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v13_bins_topo_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v13_beta_meanSEM_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 14:
    ...
    for ridx, regvar in enumerate(regvars):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v14_topo_beta_{regvar}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(plot_times)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v14_topo_beta_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v14_bins_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if len(evokeds) > 0:
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v14_bins_cbar_{regvar}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v14_bins_topo_{regvar}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v14_bins_topo_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v14_beta_meanSEM_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 15:
    ...
    for ridx, regvar in enumerate(regvars):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v15_topo_beta_{regvar}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(plot_times)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v15_topo_beta_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v15_bins_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if len(evokeds) > 0:
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v15_bins_cbar_{regvar}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v15_bins_topo_{regvar}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids)-1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v15_bins_topo_cbar_{regvar}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v15_beta_meanSEM_{regvar}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 17:
    ...
    print(f"v17 alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")

    # Response-locked plot times (seconds). We'll clip to available range automatically.
    plot_times = [-0.5, -0.4, -0.3, -0.2, -0.1, 0.0, 0.05, 0.1]

    # timepoint used for binned topographies (change if you want)
    bin_topo_time = -0.10  # seconds relative to response

    # Use actual epoch time axis (response-locked)
    times = beta_gavg[0].times
    ...
    # dynamic xticks based on response-locked window
    tmin_ms = int(np.floor(tmin * 1000 / 100) * 100)
    tmax_ms = int(np.ceil(tmax * 1000 / 100) * 100)
    xticks = np.arange(tmin_ms, tmax_ms + 1, 100)

    # ----------------------------
    # Loop regressors (pain_u, money_u)
    # ----------------------------
    for ridx, reg_beta in enumerate(regvars_betas):

        reg_epoch = regvars_epochs[ridx]   # which epochs file / metadata column to use
        reg_name  = regvarsnames[ridx]

        cmap, vminmax = cmap_map.get(reg_beta, ("viridis", 6))

        # epochs used for binning plots (saved under sv_pain_para / sv_money)
        all_epos = mne.read_epochs(
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v20_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v20_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        #    (binning uses original SV column in metadata: sv_pain_para / sv_money)
        # ----------------------------
        nbins = 5
        if reg_epoch not in all_epos.metadata.columns:
            raise RuntimeError(f"Metadata column '{reg_epoch}' not found in epochs metadata.")

        unique_vals = all_epos.metadata[reg_epoch].nunique()
        nbins_eff = min(nbins, unique_vals)

        all_epos.metadata["bin"], bins = pd.qcut(
            all_epos.metadata[reg_epoch],
            q=nbins_eff,
            labels=False,
            retbins=True,
            duplicates="drop"
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v20_bins_{reg_beta}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )

            # colorbar legend figure
            if len(evokeds) > 0:
                fig_cb, ax_cb = plt.subplots(figsize=(4, 2.5))
                cbarout = mne.viz.plot_compare_evokeds(
                    evokeds,
                ...
                cbarout[0].axes[0].remove()
                cbarout[0].savefig(
                    opj(outfigpath, f"{fig_prefix}v17_bins_cbar_{reg_beta}_{c}.svg"),
                    dpi=800,
                    bbox_inches="tight"
                )

        # ----------------------------
        # 3) Topo of binned amplitude at bin_topo_time (default −100 ms)
        # ----------------------------
        # clip bin_topo_time to available
        bt = bin_topo_time
        if bt < tmin: bt = tmin
        if bt > tmax: bt = tmax
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            tidx_bt = np.argmin(np.abs(evokeds[bin_id].times - bt))
            dat = evokeds[bin_id].data[:, tidx_bt] * 1e6
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v20_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v20_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            ax.set_xlabel("Time (ms)", fontdict={"size": param["labelfontsize"]})
            ax.set_ylabel(f"β ({reg_name}, z)", fontdict={"size": param["labelfontsize"]})
            ax.axhline(0, linestyle="--", color="gray")
            ax.axvline(0, linestyle="--", color="gray")
            ax.set_xticks(xticks)
            ax.tick_params(labelsize=param["ticksfontsize"])
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v20_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 18:
    ...
    # Bonferroni across the 2 regressors
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"v18 alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v21_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v21_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )

        # ----------------------------
        # 2) Binned-by-regressor ERP line plots (bin by metadata reg column)
        # ----------------------------
        nbins = 5
        if reg_epoch not in all_epos.metadata.columns:
            raise RuntimeError(f"Metadata column '{reg_epoch}' not found in epochs metadata.")
        ...
        # average within participants, then grand-average per bin
        sub_evokeds = []
        for p_id in all_epos.metadata["participant_id"].unique():
            sub_dat = all_epos[all_epos.metadata["participant_id"] == p_id]
            sub_ev = {}
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v21_bins_{reg_beta}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )

        # ----------------------------
        # 3) Topo of binned amplitude at bin_topo_time
        # ----------------------------
        bt = bin_topo_time
        if bt < tmin: bt = tmin
        if bt > tmax: bt = tmax
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v21_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v21_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v21_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 19:
    ...
    # ----------------------------
    ref_epo = mne.read_epochs(
        opj(outpath_glm, "ols_2ndlevel_allepochs-epo_sv_painlevel.fif"),
        preload=False
    )
    ...
    print(f"[v19] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v19] ref epochs tmin: {ref_t0:.6f} s")
    ...
    if abs(tshift) > tol:
        print(f"[v19] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print("[v19] Beta time axis already matches epochs; no shift applied.")
    
    # Now use *shifted* beta time axis everywhere below
    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v19] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the 2 regressors
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"v19 alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v22_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v22_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v22_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v22_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600,
                    bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v22_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600,
                bbox_inches="tight"
            )
...
if version == 20:
    ...
    # Load second-level outputs
    # ----------------------------
    tvals = np.load(opj(outpath_glm, "ols_2ndlevel_tvals.npy"))  # (4, n_times, n_chans)
    pvals = np.load(opj(outpath_glm, "ols_2ndlevel_pvals.npy"))  # (4, n_times, n_chans)

    beta_gavg = np.load(opj(outpath_glm, "ols_2ndlevel_betasavg.npy"), allow_pickle=True)
    allbetas  = np.load(opj(outpath_glm, "ols_2ndlevel_betas.npy"), allow_pickle=True)  # (n_subj, 4, n_chan, n_time)

    # ----------------------------
    # TIME ALIGNMENT CHECK (CRITICAL)
    # Make beta time axis match epochs you saved for binning
    # ----------------------------
    ref_epo = mne.read_epochs(
        opj(outpath_glm, "ols_2ndlevel_allepochs-epo_painlevel.fif"),
        preload=False
    ...
    print(f"[v20] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v20] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v20] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print("[v20] Beta time axis already matches epochs; no shift applied.")

    # Cue-locked long epoch time axis
    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v20] final plot time range: {tmin:.3f}..{tmax:.3f} s")

    # ----------------------------
    # Bookkeeping: MUST match v20 massuni
    # ----------------------------
    regvars_betas  = ["pain_L", "money_L", "pain_Q", "money_Q"]
    regvars_epochs = ["painlevel", "moneylevel", "painlevel", "moneylevel"]
    regvarsnames   = ["Pain (linear)", "Money (linear)", "Pain (quadratic)", "Money (quadratic)"]

    # Colormap mapping (optional; if missing -> viridis)
    cmap_map = {
        "pain_L":  ("Blues", 6),
        "money_L": ("Greens", 6),
        "pain_Q":  ("Purples", 6),
    ...
    # Bonferroni across 4 regressors
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v20] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    # helper: load the correct epochs file for binning
    def load_binning_epochs(epoch_key):
        # epoch_key is "painlevel" or "moneylevel"
        fname = f"ols_2ndlevel_allepochs-epo_{epoch_key}.fif"
        return mne.read_epochs(opj(outpath_glm, fname), preload=True)
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        reg_epoch = regvars_epochs[ridx]   # painlevel or moneylevel
        reg_name  = regvarsnames[ridx]

        cmap, vminmax = cmap_map.get(reg_beta, ("viridis", 6))

        # epochs used for binning (same painlevel/moneylevel epochs file for both L and Q)
        all_epos = load_binning_epochs(reg_epoch)
        all_epos.metadata = all_epos.metadata.reset_index(drop=True)
        ...
        # ----------------------------
        # 2) Binned-by-regressor ERP line plots
        # For quadratic regressors, bin by "extremeness" (= squared, centered) using metadata
        # ----------------------------
        nbins = 5
        if reg_epoch not in all_epos.metadata.columns:
            raise RuntimeError(f"Metadata column '{reg_epoch}' not found in epochs metadata.")

        # build the binning variable
        x = all_epos.metadata[reg_epoch].to_numpy(float)
        x_c = x - np.nanmean(x)

        if reg_beta.endswith("_Q"):
            bin_var = x_c ** 2   # extremeness
            bin_label = f"{reg_epoch}^2"
        else:
            bin_var = x          # raw level
            bin_label = reg_epoch

        # handle duplicates/low unique values
        unique_vals = pd.Series(bin_var).nunique()
        nbins_eff = int(min(nbins, unique_vals))
        if nbins_eff < 2:
            print(f"[v20] WARNING: {reg_beta} has <2 unique bin values; skipping bin plots.")
            continue
        ...
        for c in chan_to_plot:
            ...
            ax.set_title(f"{reg_name} binned by {bin_label}", fontsize=param["titlefontsize"])
            ax.tick_params(labelsize=param["ticksfontsize"])
            ax.legend(fontsize=param["legendfontsize"], frameon=False)
            fig.tight_layout()
    ...
    # Load second-level outputs
    # ----------------------------
    tvals = np.load(opj(outpath_glm, "ols_2ndlevel_tvals.npy"))  # (1, n_times, n_chans)
    pvals = np.load(opj(outpath_glm, "ols_2ndlevel_pvals.npy"))  # (1, n_times, n_chans)

    beta_gavg = np.load(opj(outpath_glm, "ols_2ndlevel_betasavg.npy"), allow_pickle=True)
    allbetas  = np.load(opj(outpath_glm, "ols_2ndlevel_betas.npy"),    allow_pickle=True)  # (n_subj, 1, n_chan, n_time)
    ...
    print(f"[v24] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v24] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v24] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print("[v24] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v24] final plot time range: {tmin:.3f}..{tmax:.3f} s")

    # ----------------------------
    # Bookkeeping (SINGLE beta)
    # ----------------------------
    regvars_betas  = ["sv_pain_para"]
    regvars_epochs = ["sv_pain_para"]
    regvarsnames2  = ["SV_pain_para"]

    cmap_map = {
        "sv_pain_para": ("Blues", 6),
    }

    # no Bonferroni needed across regressors (only 1)
    alpha_eff = param["alpha"]
    print(f"[v24] alpha_eff = {alpha_eff} (single regressor)")
    ...
    # ----------------------------
    # Loop regressor (only sv_pain_para)
    # ----------------------------
    for ridx, reg_beta in enumerate(regvars_betas):

        reg_epoch = regvars_epochs[ridx]
        reg_name  = regvarsnames2[ridx]

        cmap, vminmax = cmap_map.get(reg_beta, ("viridis", 6))

        # epochs used for binning plots (NOTE: v24 file has sv_pain_para)
        all_epos = mne.read_epochs(
            opj(outpath_glm, f"ols_2ndlevel_allepochs-epo_{reg_epoch}.fif"),
            preload=True
        )
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v24_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v24_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )

        # ----------------------------
        # 2) Binned-by-regressor ERP line plots (bin by sv_pain_para metadata)
        # ----------------------------
        nbins = 5
        if reg_epoch not in all_epos.metadata.columns:
            raise RuntimeError(f"Metadata column '{reg_epoch}' not found in epochs metadata.")
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v24_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v24_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v24_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v24_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            ) 
    ...
    print(f"[v25|{v25_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v25|{v25_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v25|{v25_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v25|{v25_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v25|{v25_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v25|{v25_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v25_{v25_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
    ...
    print(f"[v26|{v26_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v26|{v26_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v26|{v26_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v26|{v26_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v26|{v26_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")

    # ----------------------------
    # Bookkeeping (always 2 betas saved: painlevel, moneylevel)
    # ----------------------------
    regvars_betas  = ["sv_pain_para", "sv_money"]   # index order in saved arrays
    regvars_epochs = ["sv_pain_para", "sv_money"]   # filenames for saved epochs
    regvarsnames   = ["SV_pain_para", "SV_money"]   # for titles
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v26|{v26_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v26_{v26_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )               
    ...
    print(f"[v27|{v27_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v27|{v27_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v27|{v27_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v27|{v27_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v27|{v27_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v27|{v27_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v27_{v27_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
    ...
    print(f"[v28|{v28_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v28|{v28_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v28|{v28_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v28|{v28_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v28|{v28_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v28|{v28_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v28_{v28_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )         
    ...
    print(f"[v29|{v29_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v29|{v29_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v29|{v29_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v29|{v29_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v29|{v29_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v29|{v29_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v29_{v29_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
    ...
    print(f"[v30|{v30_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v30|{v30_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v30|{v30_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v30|{v30_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v30|{v30_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v30|{v30_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v30_{v30_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
    ...
    print(f"[v31|{v31_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v31|{v31_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v31|{v31_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v31|{v31_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v31|{v31_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v31|{v31_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.tight_layout()
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v31_{v31_mode}_beta_meanSEM_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
    ...
    print(f"[v31|{v32_mode}] beta_gavg tmin: {beta_t0:.6f} s")
    print(f"[v31|{v32_mode}] ref epochs tmin: {ref_t0:.6f} s")

    tol = 0.5 / param["testresampfreq"]
    tshift = ref_t0 - beta_t0

    if abs(tshift) > tol:
        print(f"[v31|{v32_mode}] Shifting beta time axis by {tshift:.6f} s to match epochs.")
        beta_gavg = np.array(
            [ev.copy().shift_time(tshift, relative=True) for ev in beta_gavg],
            dtype=object
        )
    else:
        print(f"[v31|{v32_mode}] Beta time axis already matches epochs; no shift applied.")

    times = beta_gavg[0].times
    tmin, tmax = float(times[0]), float(times[-1])
    print(f"[v31|{v32_mode}] final plot time range: {tmin:.3f}..{tmax:.3f} s")
    ...
    # Bonferroni across the TWO betas you are plotting
    alpha_eff = param["alpha"] / len(regvars_betas)
    print(f"[v31|{v32_mode}] alpha_eff = {alpha_eff} (alpha={param['alpha']} / {len(regvars_betas)})")
    ...
    for ridx, reg_beta in enumerate(regvars_betas):
        ...
        for tidx, timepos in enumerate(times_pos):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v32_{v32_mode}_topo_beta_{reg_beta}_{tidx}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if tidx == (len(times_pos) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v32_{v32_mode}_topo_beta_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
        ...
        for c in chan_to_plot:
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v32_{v32_mode}_bins_{reg_beta}_{c}.svg"),
                dpi=600, bbox_inches="tight"
            )
        ...
        for bi, bin_id in enumerate(bin_ids):
            ...
            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v32_{v32_mode}_bins_topo_{reg_beta}_bin{bin_id}.svg"),
                dpi=600, bbox_inches="tight"
            )
            ...
            if bi == (len(bin_ids) - 1):
                ...
                cbar.ax.tick_params(labelsize=param["ticksfontsize"]-2)
                fig2.savefig(
                    opj(outfigpath, f"{fig_prefix}v32_{v32_mode}_bins_topo_cbar_{reg_beta}.svg"),
                    dpi=600, bbox_inches="tight"
                )
...
if version == 35:
    ...
    for set_name in electrode_sets:
        ...
        for regvar in sorted(rp_stats["regvar"].unique()):
            sdf = rp_stats[rp_stats["regvar"] == regvar].sort_values(["bin_tmin", "bin_tmax"])

            x = np.arange(len(sdf))
            means = sdf["mean_beta"].to_numpy()
            sems  = sdf["sem_beta"].to_numpy()
    ...
    subj_csv  = rp_dir / "v38_nosv_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v38_nosv_group_regress_rp_on_subject_predictors_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v38_nosv_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v38_nosv_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V38 NO-SV PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V38 (no-SV) Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v38_nosv_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)

    # -----------------------
    # 2) Group betas by bin
    # -----------------------
    group_df = group_df.copy()
    group_df["bin_label"] = group_df.apply(lambda r: bin_label(r.bin_tmin, r.bin_tmax), axis=1)
    has_fdr = "p_fdr_bh" in group_df.columns
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            models = sorted(sdf_pred["model"].unique())  # ["joint_plus_rt","separate_plus_rt"] typically
            ...
            for mi, model in enumerate(models):
                ...
                for i in range(len(betas)):
                    ...
                    sig = (np.isfinite(pfdr[i]) and pfdr[i] < 0.05) or (
                        not np.isfinite(pfdr[i]) and np.isfinite(pvals[i]) and pvals[i] < 0.05
                    )
                    if sig:
                        ax.text(xpos[i], betas[i], "*", ha="center", va="bottom", fontsize=14)
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V38 (no-SV, RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v38_nosv_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)

    # -----------------------
    # 3) Scatter plots: rp_mean_uV vs predictors (+ rt_subj)
    # -----------------------
    subj_df = subj_df.copy()
    subj_df["bin_label"] = subj_df.apply(lambda r: bin_label(r.bin_tmin, r.bin_tmax), axis=1)

    # only predictors that exist in the NO-SV subject table
    candidate_preds = [c for c in ["v_painlevel_subj", "v_moneylevel_subj", "rt_subj"] if c in subj_df.columns]
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V38 (no-SV) {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v38_nosv_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v40_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v40_group_regress_rp_on_a_predictors_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v40_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v40_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V40 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V40 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v40_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)

    # -----------------------
    # 2) Group betas by bin (annotate raw p + FDR + Bonf)
    # -----------------------
    group_df = group_df.copy()
    group_df["bin_label"] = group_df.apply(lambda r: bin_label(r.bin_tmin, r.bin_tmax), axis=1)

    has_fdr  = "p_fdr_bh" in group_df.columns
    has_bonf = "p_bonf" in group_df.columns
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            for mi, model in enumerate(models):
                ...
                pvals = sdf_m["p"].to_numpy(dtype=float)
                pfdr  = sdf_m["p_fdr_bh"].to_numpy(dtype=float) if has_fdr else np.full_like(betas, np.nan)
                pbonf = sdf_m["p_bonf"].to_numpy(dtype=float)   if has_bonf else np.full_like(betas, np.nan)
                ...
                for i in range(len(betas)):
                    ...
                    # significance marker (prefer FDR if available, else Bonf, else raw p)
                    if np.isfinite(pfdr[i]):
                        sig = pfdr[i] < 0.05
                    elif np.isfinite(pbonf[i]):
                        sig = pbonf[i] < 0.05
                    else:
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V40 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v40_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    candidate_preds = [c for c in ["a_painlevel_subj", "a_moneylevel_subj", "rt_subj"] if c in subj_df.columns]
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V40 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v40_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v41_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v41_group_regress_rp_on_v_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v41_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v41_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V41 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V41 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v41_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V41 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v41_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V41 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v41_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v42_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v42_group_regress_rp_on_v_by_bin.csv"
    ...
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v42_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v42_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V42 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V42 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v42_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            models = sorted(sdf_pred["model"].unique())
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V42 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v42_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V42 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v42_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v43_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v43_group_regress_rp_on_a_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v43_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v43_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V43 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V43 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v43_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V43 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v43_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V43 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v43_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v44_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v44_group_regress_rp_on_v_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v44_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v44_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V44 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V44 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v44_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V44 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v44_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    # include interaction in scatter candidates
    candidate_preds = [c for c in ["v_painlevel_subj", "v_moneylevel_subj", "v_interaction_subj", "rt_subj"]
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V44 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v44_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
    ...
    subj_csv  = rp_dir / "v45_subject_level_rp_means_by_bin.csv"
    group_csv = rp_dir / "v45_group_regress_rp_on_a_by_bin.csv"
    ...
    # -----------------------
    for set_name in electrode_sets:
        wf_npy = rp_dir / f"v45_{set_name}__rp_subject_waveforms.npy"
        t_npy  = rp_dir / f"v45_{set_name}__rp_times.npy"

        if not (wf_npy.exists() and t_npy.exists()):
            print(f"[V45 PLOT] Missing waveform files for {set_name}: {wf_npy} / {t_npy}")
            continue
        ...
        ax.set_xlabel("Time from response (ms)")
        ax.set_ylabel("Amplitude (µV)")
        ax.set_title(f"V45 Grand-average RP: {set_name}")
        fig.tight_layout()
        fig.savefig(
            opj(outfigpath, f"{fig_prefix}v45_{set_name}__rp_grand_average_waveform.svg"),
            dpi=600, bbox_inches="tight"
        )
        plt.close(fig)
    ...
    for set_name in electrode_sets:
        ...
        for predictor in sorted(sdf_set["predictor"].unique()):
            ...
            ax.set_xticklabels(bins_sorted["bin_label"].to_list())
            ax.set_ylabel("β (standardized)")
            ax.set_title(f"V45 (RT-controlled): RP_mean_uV ~ {predictor}\n{set_name}")
            ax.legend(frameon=False)
            fig.tight_layout()

            fig.savefig(
                opj(outfigpath, f"{fig_prefix}v45_{set_name}__betas_{predictor}.svg"),
                dpi=600, bbox_inches="tight"
            )
            plt.close(fig)
    ...
    # a-model scatter candidates (+ RT)
    candidate_preds = [
        c for c in ["a_painlevel_subj", "a_moneylevel_subj", "a_interaction_subj", "rt_subj"]
        if c in subj_df.columns
    ]
    ...
    for set_name in electrode_sets:
        ...
        for (tmin, tmax), sdf_bin in sdf_set.groupby(["bin_tmin", "bin_tmax"]):
            for pred in candidate_preds:
                ...
                ax.set_xlabel(pred)
                ax.set_ylabel("RP mean (µV)")
                ax.set_title(f"V45 {set_name} {bin_label(tmin,tmax)}\nr={r:.2f}, p={p:.3f}")
                fig.tight_layout()
                fig.savefig(
                    opj(outfigpath, f"{fig_prefix}v45_{set_name}__scatter_rpmean__{pred}__{tmin:.2f}_{tmax:.2f}.svg"),
                    dpi=600, bbox_inches="tight"
                )
                plt.close(fig)
