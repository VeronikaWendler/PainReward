...
if version == 1:
    ...
    outpath = opj(outpathall, 'statistics/erps_massuni_drift_mod_9_2_RT')   
    outfigpath = opj(outpathall, 'figures/erps_massuni_drift_mod_9_2_RT')   
    if not os.path.exists(outfigpath):
        os.mkdir(outfigpath)
elif version == 4:
...
param = {
    'alpha': 0.05 / 3,     # Bonferroni over 3 regressors
    'titlefontsize': 12,
    'labelfontsize': 12,
    'ticksfontsize': 11,
    'legendfontsize': 10,
