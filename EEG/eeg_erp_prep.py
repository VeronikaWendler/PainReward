...
for p in part:
    ...
    if version == 1:
        ...
        print("ERPs for cues off+ for Version 1")
        # Adding plot_image
    ...
    if version == 1:
        erp_cues_single.save(opj(outdir, p
                             ...
                             overwrite=True)
        print("erp_cues_single.save(opj(outdir,p_decision_cues_singletrials-epo.fif')")
...
if version == 1:
    ...
    print("all_meta.to_csv(opj(outpath, 'decision_erpsmeta.csv'), index=False)")   
...
if version == 1:
    for p in tqdm(part):
        ...
        if not os.path.exists(outdir_erp):
            os.mkdir(outdir_erp)
        print("outdir_erp = opj(outpath,  p, 'eeg', 'erps')")
