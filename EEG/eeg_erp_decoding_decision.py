...
#      - money: corr-r
#      - pain : corr-r
#      - raw and ctrlOther (other cue ONLY)
#      - shuffle controls
#      - group cluster permutation tests over time + time plots
...
def select_trials_decision_binary(epo: mne.Epochs, which: str, control_resid_by_other: bool):
    ...
    info = dict(
        ...
        n_after_nan=int(len(y)),   # (kept for compatibility; no NaN-dropping step now)
...
def run_binary(which: str, shuffle: bool, tag: str, control_by_other: bool):
    ...
    trial_stats = dict(
        ...
        total_trials_after_nan=0,  # kept for compatibility; equals after_level here
        n_trials_per_sub=[],
    )
        ...
        try:
            ...
            append_subject_summary(
                ...
                extra=dict(
                    ...
                    control_rt=False,
                    other_quad=bool(control_by_other),
...
def run_crossgen_binary(train: str, shuffle: bool, tag: str, control_by_other_train: bool):
    ...
    np.savez(
        ...
        chance=CHANCE_BIN,
        control_rt=False,
        other_quad=bool(control_by_other_train),
    )
    np.savez(
