#!/bin/bash
#SBATCH --job-name=rp_bf_recovery_run2
#SBATCH --time=3:00:00
#SBATCH --cpus-per-task=12
#SBATCH --mem=128G
#SBATCH --output=logs/rp_bf_recovery_run2_%j.out
#SBATCH --error=logs/rp_bf_recovery_run2_%j.err
...
echo "OUTDIR=${OUTDIR}"
echo "Starting BayesFlow recovery run 2..."
